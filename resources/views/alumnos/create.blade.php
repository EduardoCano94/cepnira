...
<div class="max-w-4xl mx-auto">
    ...
    {{-- TUTOR DIFERENTE + DOCUMENTO PROBATORIO --}}
    <div class="bg-white rounded-xl shadow p-6 mb-4">
        ...
        <div id="seccion_tutor" class="{{ old('tutor_diferente') ? '' : 'hidden' }}">
            ...
            <h3 class="font-bold text-white bg-red-700 px-3 py-1 rounded mb-2 text-sm uppercase">Documento Probatorio</h3>
            <p class="text-xs text-gray-400 italic mb-4">* Llenar porque el tutor es diferente al padre o madre.</p>
            <div class="grid grid-cols-3 gap-4 mb-4">
                <div>
                ...
                <div class="flex flex-wrap gap-4 text-sm">
                    <label class="flex items-center gap-2">
                        <input type="radio" name="tipo_documento" value="acta_nacimiento"
                            ...
                            onchange="cambiarDocumento('acta_nacimiento')"> Acta de Nacimiento
                    </label>
                    <label class="flex items-center gap-2">
                        <input type="radio" name="tipo_documento" value="documento_migratorio"
                            {{ old('tipo_documento')=='documento_migratorio' ? 'checked' : '' }}
                            onchange="cambiarDocumento('documento_migratorio')"> Documento Migratorio
                    </label>
                    <label class="flex items-center gap-2">
                        <input type="radio" name="tipo_documento" value="naturalizacion_sre"
                            {{ old('tipo_documento')=='naturalizacion_sre' ? 'checked' : '' }}
                            onchange="cambiarDocumento('naturalizacion_sre')"> Naturalización SRE
                    </label>
                    <label class="flex items-center gap-2">
                        <input type="radio" name="tipo_documento" value="ficha_signaléctica"
                            {{ old('tipo_documento')=='ficha_signaléctica' ? 'checked' : '' }}
                            onchange="cambiarDocumento('ficha_signaléctica')"> Ficha Signalética
                    </label>
                    <label class="flex items-center gap-2">
                        <input type="radio" name="tipo_documento" value="no_entrego"
                            {{ old('tipo_documento')=='no_entrego' ? 'checked' : '' }}
                            onchange="cambiarDocumento('no_entrego')"> No entregó documento
                    </label>
                </div>
            </div>

            {{-- Campos dinámicos --}}
            <div id="campos_acta" class="grid grid-cols-3 gap-4 mb-4 hidden">
                <div>
            ...
            <div id="campos_migratorio" class="grid grid-cols-2 gap-4 mb-4 hidden">
                <div>
                    <label class="block text-xs font-medium text-gray-600 mb-1">No. Registro Nacional de Extranjeros</label>
                    <input type="text" name="num_registro_extranjeros" value="{{ old('num_registro_extranjeros') }}"
                        class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none">
                </div>
            </div>
            <div id="campos_naturalizacion" class="grid grid-cols-2 gap-4 mb-4 hidden">
                <div>
                    <label class="block text-xs font-medium text-gray-600 mb-1">Folio de la Carta</label>
                    <input type="text" name="folio_carta" value="{{ old('folio_carta') }}"
                        class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none">
                </div>
            </div>
            <div id="campos_signaletica" class="grid grid-cols-2 gap-4 mb-4 hidden">
                <div>
                    <label class="block text-xs font-medium text-gray-600 mb-1">No. de Juzgado</label>
...
function cambiarDocumento(tipo) {
    ...
    const mapa = {
        ...
        'ficha_signaléctica':   'campos_signaletica',
    };
